<xsl:stylesheet  version='1.0' xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                 ...
                 xmlns:convert="http://www.oracle.com/XSL/Transform/java/com.sutternow.notes.ConvertTomboyToEverNote"
                 exclude-result-prefixes="tomboy link size convert">
  ...
  <xsl:template match="tomboy:note" xsl:exclude-result-prefixes="tomboy size link convert">
  ...
  <!--<title>
     ...
     <!-- <a name="{convert:toNMToken(/tomboy:note/tomboy:title)}" />-->
